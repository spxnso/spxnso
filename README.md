...
Learn how to configure CI for Lute projects- **[Introducing my portfolio](https://spxnso.dev/blog/introducing-my-portfolio)**

Coding the logic behind the blog is easy, but writing the blogs is hard<!-- BLOG-POST-LIST:END -->
